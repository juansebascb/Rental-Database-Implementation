...
--  Lab Assignment: N/A
--  Program Author: Sebastian Calle
--  Creation Date:  05-Feb-2017
-- ------------------------------------------------------------------
-- This creates tables, sequences, indexes, and constraints that will 
-- be used to build on. This file is a copy of the code given by the
-- instructor. Demonstrates proper process and syntax.
-- ------------------------------------------------------------------
